...
/**
 * The Root Agent Provider for the Tutor module.
 * This agent orchestrates educational interactions, delegating specific
 * subject inquiries (e.g., Code, Math, Science) to specialized sub-agents.
 */
