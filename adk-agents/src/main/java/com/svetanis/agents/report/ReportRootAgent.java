...
/**
 * The Root Agent Provider for the Report module.
 * This agent orchestrates the workflow for generating comprehensive reports
 * by delegating research and content aggregation to specialized sub-agents.
 */
