...
/**
 * The Root Agent Provider for the Blogger module.
 * This agent orchestrates the end-to-end blogging process by delegating
 * parallel research tasks and aggregating content into a final blog post.
 */
