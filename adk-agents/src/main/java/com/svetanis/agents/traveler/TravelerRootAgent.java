...
/**
 * The Root Agent Provider for the Traveler module.
 * This orchestrator agent gathers user preferences and delegates travel-related
 * tasks (flights, accommodation, activities) to the TripSearchTeam.
 */
